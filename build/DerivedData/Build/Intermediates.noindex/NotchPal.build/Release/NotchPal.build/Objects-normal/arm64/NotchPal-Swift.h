...
#ifndef NOTCHPAL_SWIFT_H
#define NOTCHPAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotchPal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8NotchPal13CameraManager")
@interface CameraManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSCoder;
SWIFT_CLASS("_TtC8NotchPal17CameraPreviewView")
@interface CameraPreviewView : NSView
- (nonnull instancetype)initWithFrame:(NSRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layout;
@end

SWIFT_CLASS("_TtC8NotchPal17PassthroughWindow")
@interface PassthroughWindow : NSWindow
